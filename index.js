...
app.post("/submit", (req, res) => {
  ...
  let randomAdjValue = adj[Math.floor(Math.random() * adj.length)];
  let randomNunValue = noun[Math.floor(Math.random() * noun.length)];
  let bandName = randomAdjValue + " " + randomNunValue;
